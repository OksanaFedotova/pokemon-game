...
export const getUserUpdateAsync = () => async (dispatch) => {
    ...
    if (idToken) {
        ...
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAFfakVfKBqJlmGqcUJE7ar-UaarQuY4IY', requestOpions).then(res => res.json());
